...
import static constants.FileConstant.*;
import static constants.SecurityConstant.JWT_TOKEN_HEADER;
import static org.springframework.http.HttpStatus.OK;
import static org.springframework.http.MediaType.IMAGE_JPEG_VALUE;

@Tag(description = "User resources that provides access to availabe user data",
        name = "User resource")
@RestController

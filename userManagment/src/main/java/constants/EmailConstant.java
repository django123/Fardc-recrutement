...
public class EmailConstant {
    ...
    public static final String USERNAME = "jeanedouga@gmail.com";
    public static final String PASSWORD = "edouga123";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "Farcd Peguy, LLC - New Password";
